...
- Normal and nuclear grenades launch at 450 units/second with an upward toss and a 2.8-second fuse. Their unassisted horizontal travel stays below half the 2560-unit arena, including throws from high platforms; bounces shorten the range. The single-use nuclear grenade is thrown with attack or the throw-weapon action. Its 850-unit core blast creates a mushroom cloud, an expanding 3600-unit pressure wave, rolling dust and six marked secondary detonations. The wave damages and launches fighters, collapses breakable floors and cover, and throws loose weapons, projectiles and debris. Structural floors reduce nuclear damage but remain intact; they fully contain ordinary blasts. Both grenades can hurt the shooter and detonate if they leave the arena. Scoring waits for any live nuclear grenade and its 4.8-second blast sequence to resolve.
