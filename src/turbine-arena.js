...
export const TURBINE_ARENA = {
  ...
  traps: [
    ...Array.from({ length: 6 }, (_, i) => ({ type: "turbine", x: (i + .5) * 2560 / 6,
      y: 1460, w: TURBINE_RADIUS * 2, h: 276, dir: i % 2 ? -1 : 1 })),
  ],
};

// The turbine row opens into the machinery void. Only the hall's vertical side
// walls are solid; there is deliberately no horizontal floor below the rotors.
